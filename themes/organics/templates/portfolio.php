						...
						<div class="post_content clearfix">
							...
							<?php if ($post_data['post_link'] != '') { ?>
								<div class="post_buttons">
									<?php echo trim(organics_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('LEARN MORE', 'organics'))); ?>
								</div>
							<?php } ?>
						</div>
					</div>				<!-- /.post_content -->
        ...
        ?>">
            ...
            echo ($post_options['hover'] ? ' '.esc_attr($post_options['hover']) : '')
                ...
                <div class="img-container">
                    <div class="post_featured img">
                        <?php echo ($link_start) . ($post_data['post_thumb']) . ($link_end); ?>
                    </div>
                </div>	<!-- .img-container -->
                    ...
                    <div class="post_info_wrap info"><div class="info-back">
                            ...
                            <div class="post_descr">
                                ...
                                <div class="post_category_block">
                                    <h6 class="post_category"><?php echo ($category); ?></h6>
                                    <div class="post_arrow"><?php
                                        if ($post_options['filters']=='categories') {
                                            echo ($link_start)?><span class="icon-right-1"></span><?php echo ($link_end);
                                        } else '';
                                        ?></div>
                                </div>
                            </div>
								...
								if ($post_data['post_protected']) {
									...
									if ($post_data['post_link'] != '') {
										...
										if ($style=='colored_1') {
											...
											echo trim(organics_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('Learn more', 'organics')));
											?></span><?php
