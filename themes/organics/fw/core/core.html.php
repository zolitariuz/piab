...
if (!function_exists('organics_html_theme_setup')) {
	...
	function organics_html_theme_setup() {
		...
		add_filter( 'wp_mail_content_type', 'organics_set_html_content_type' );
...
if (!function_exists('organics_set_html_content_type')) {
	function organics_set_html_content_type() {
		return 'text/html';
	}
}
