...
class organics_widget_recent_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_posts', 'description' => esc_html__('The recent blog posts (extended)', 'organics'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'organics_widget_recent_posts');

		/* Create the widget. */
		parent::__construct( 'organics_widget_recent_posts', esc_html__('Organics - Recent Posts', 'organics'), $widget_ops, $control_ops );
	...
	function form($instance) {
		...
		$counters = array_merge(array('hide' => esc_html__('Hide', 'organics')), organics_get_list_blog_counters(false));
