...
class organics_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => esc_html__('Recent reviews', 'organics'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'organics_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'organics_widget_recent_reviews', esc_html__('Organics - Recent reviews', 'organics'), $widget_ops, $control_ops );
